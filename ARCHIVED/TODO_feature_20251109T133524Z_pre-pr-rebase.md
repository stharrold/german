...
metadata:
  title: "Pre Pr Rebase"
  description: "Feature for pre-pr-rebase"
  created: "2025-11-09T13:35:24.908056Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-09T13:35:24.908056Z"
  status: "planning"
...
Feature for pre-pr-rebase

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-09T13:35:24.908056Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pre-pr-rebase/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pre-pr-rebase/architecture.md`
...
cat TODO_feature_20251109T133524Z_pre-pr-rebase.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pre-pr-rebase contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251109T133524Z_pre-pr-rebase.md <task_id> <status>
...
- 2025-11-09T13:35:24.908056Z: Workflow initialized
