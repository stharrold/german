...
metadata:
  title: "Pr 139 Issues"
  description: "Feature for pr-139-issues"
  created: "2025-11-09T16:01:03.702174Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-09T16:01:03.702174Z"
  status: "planning"
...
Feature for pr-139-issues

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-09T16:01:03.702174Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pr-139-issues/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pr-139-issues/architecture.md`
...
cat TODO_feature_20251109T160102Z_pr-139-issues.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pr-139-issues contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251109T160102Z_pr-139-issues.md <task_id> <status>
...
- 2025-11-09T16:01:03.702174Z: Workflow initialized
