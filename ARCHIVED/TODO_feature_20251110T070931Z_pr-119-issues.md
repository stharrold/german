...
metadata:
  title: "Pr 119 Issues"
  description: "Feature for pr-119-issues"
  created: "2025-11-10T07:09:31.852458Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-10T07:09:31.852458Z"
  status: "planning"
...
Feature for pr-119-issues

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-10T07:09:31.852458Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pr-119-issues/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pr-119-issues/architecture.md`
...
cat TODO_feature_20251110T070931Z_pr-119-issues.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pr-119-issues contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251110T070931Z_pr-119-issues.md <task_id> <status>
...
- 2025-11-10T07:09:31.852458Z: Workflow initialized
