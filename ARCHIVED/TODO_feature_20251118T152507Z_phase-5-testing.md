...
metadata:
  ...
  description: "Feature for phase-5-testing"
  created: "2025-11-18T15:25:08.224210Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-18T15:25:08.224210Z"
  status: "planning"
...
Feature for phase-5-testing

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-18T15:25:08.224210Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/phase-5-testing/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/phase-5-testing/architecture.md`
...
cat TODO_feature_20251118T152507Z_phase-5-testing.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature phase-5-testing contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251118T152507Z_phase-5-testing.md <task_id> <status>
...
- 2025-11-18T15:25:08.224210Z: Workflow initialized
