...
metadata:
  title: "Pr 145 Issues"
  description: "Feature for pr-145-issues"
  created: "2025-11-10T06:58:03.327026Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-10T06:58:03.327026Z"
  status: "planning"
...
Feature for pr-145-issues

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-10T06:58:03.327026Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pr-145-issues/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pr-145-issues/architecture.md`
...
cat TODO_feature_20251110T065802Z_pr-145-issues.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pr-145-issues contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251110T065802Z_pr-145-issues.md <task_id> <status>
...
- 2025-11-10T06:58:03.327026Z: Workflow initialized
