...
metadata:
  ...
  description: "Feature for pr-119-docs-clarifications"
  created: "2025-11-09T04:53:14.735209Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-09T04:53:14.735209Z"
  status: "planning"
...
# TODO: Pr 119 Docs Clarifications
...
Feature for pr-119-docs-clarifications

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-09T04:53:14.735209Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pr-119-docs-clarifications/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pr-119-docs-clarifications/architecture.md`
...
cat TODO_feature_20251109T045314Z_pr-119-docs-clarifications.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pr-119-docs-clarifications contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251109T045314Z_pr-119-docs-clarifications.md <task_id> <status>
...
- 2025-11-09T04:53:14.735209Z: Workflow initialized
