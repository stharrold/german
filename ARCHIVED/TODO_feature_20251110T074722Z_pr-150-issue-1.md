...
metadata:
  ...
  description: "Feature for pr-150-issue-1"
  created: "2025-11-10T07:47:23.212231Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-10T07:47:23.212231Z"
  status: "planning"
...
Feature for pr-150-issue-1

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-10T07:47:23.212231Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/pr-150-issue-1/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/pr-150-issue-1/architecture.md`
...
cat TODO_feature_20251110T074722Z_pr-150-issue-1.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature pr-150-issue-1 contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251110T074722Z_pr-150-issue-1.md <task_id> <status>
...
- 2025-11-10T07:47:23.212231Z: Workflow initialized
