...
metadata:
  ...
  description: "Feature for phase-6-benchmarks"
  created: "2025-11-18T15:49:17.534210Z"
  stack: python
  package_manager: uv
...
workflow_progress:
  ...
  current_step: "1.1"
  last_task: null
  last_update: "2025-11-18T15:49:17.534210Z"
  status: "planning"
...
Feature for phase-6-benchmarks

## Current Status

**Phase:** Planning (1)
**Current Step:** 1.1
**Last Updated:** 2025-11-18T15:49:17.534210Z
...
- [ ] **plan_001**: Create requirements.md
  ...
  - Location: `planning/phase-6-benchmarks/requirements.md`

- [ ] **plan_002**: Create architecture.md
  - Design system architecture and components
  - Location: `planning/phase-6-benchmarks/architecture.md`
...
cat TODO_feature_20251118T154916Z_phase-6-benchmarks.md

# Create feature worktree
python .claude/skills/git-workflow-manager/scripts/create_worktree.py feature phase-6-benchmarks contrib/stharrold

# Update task status
python .claude/skills/workflow-utilities/scripts/todo_updater.py TODO_feature_20251118T154916Z_phase-6-benchmarks.md <task_id> <status>
...
- 2025-11-18T15:49:17.534210Z: Workflow initialized
